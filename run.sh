...
# python code/main.py --train --val -d "car_dataset_split" -e 100 -m "yolo12s.pt"
python code/main.py --train --resume -d "car_dataset_split" -e 100 -m "runs/train/yolo12s_car_dataset_split/weights/last.pt"
